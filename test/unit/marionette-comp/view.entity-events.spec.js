describe('view entity events', function() {
    ...
    beforeEach(function() {
        ...
        this.modelEventsStub = this.sinon.stub().returns({
            'foo': this.fooStub
        });
        this.collectionEventsStub = this.sinon.stub().returns({
            'bar': this.barStub
        });
    });
    ...
    describe('when LayoutView bound to modelEvent replaces region with new view', function() {
        beforeEach(function() {
            ...
            this.itemViewOne = new this.ItemView({
                model: this.model
            });
            this.itemViewTwo = new this.ItemView({
                model: this.model
            });
