describe('collection view - filter', function() {
    ...
    beforeEach(function() {
        ...
        this.passModel = new Backbone.Model({
            foo: 'true'
        });
        this.failModel = new Backbone.Model({
            foo: 'false'
        });
    ...
    describe('combined with a sort', function() {
        beforeEach(function() {
            ...
            this.model3 = new Backbone.Model({
                foo: 'true',
                bar: 3
            });
            this.model4 = new Backbone.Model({
                foo: 'false',
                bar: 4
            });
