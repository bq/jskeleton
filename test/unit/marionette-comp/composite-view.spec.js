describe('composite view', function() {
    ...
    describe('when a composite view has a template without a model', function() {
        beforeEach(function() {
            ...
            this.m1 = new this.Model({
                foo: 'bar'
            });
            this.m2 = new this.Model({
                foo: 'baz'
            });
    ...
    describe('when a composite view has a model and a template', function() {
        ...
        it('should pass template fn, data, and view instance to JSkeleton.Renderer.Render', function() {
            expect(Marionette.Renderer.render).to.have.been.calledWith(this.templateFn, {
                foo: 'bar'
            }, this.compositeView);
        });
    });
    ...
    describe('when rendering a composite with a collection', function() {
        ...
        describe('and then resetting the collection', function() {
            beforeEach(function() {
                this.m3 = new this.Model({
                    foo: 'quux'
                });
                this.m4 = new this.Model({
                    foo: 'widget'
                });
